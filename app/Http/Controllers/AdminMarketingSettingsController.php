    ...
    public function update(Request $request)
    {
        ...
        if ($type === 'bonus_marketing') {
            ...
            return redirect()
                ...
                ->with('success', 'Pengaturan bonus marketing berhasil diperbarui.');
        }

        if ($type === 'download_prompt') {
            $validated = $request->validate([
            ...
            return redirect()
                ->route('admin.marketing-settings')
                ->with('success', 'Pengaturan popup download berhasil diperbarui.');
        }

        return redirect()
            ->route('admin.marketing-settings')
            ->with('error', 'Tipe pembaruan tidak valid.');
    }
}

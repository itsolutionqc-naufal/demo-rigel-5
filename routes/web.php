...
Route::delete('users/{id}/force', [App\Http\Controllers\UserController::class, 'forceDestroy'])
    ->middleware(['auth', 'verified', 'admin.only'])
...
Route::prefix('app')->middleware(['auth', 'verified', 'role:user,admin,marketing'])->group(function () {
...
Route::post('/tg-webhook', [App\Http\Controllers\TelegramWebhookController::class, 'handleWebhook'])
    ->withoutMiddleware([
        \Illuminate\Cookie\Middleware\EncryptCookies::class,
        \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
        \Illuminate\Session\Middleware\StartSession::class,

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <script>
            // Initialize Lucide icons on first load and after every Livewire wire:navigate
            function initLucide() {
            ...
            // After wire:navigate (Livewire SPA navigation)
            document.addEventListener('livewire:navigated', initLucide);

            // Fallback: also listen to Livewire page update events

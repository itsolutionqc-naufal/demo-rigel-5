<x-layouts::app :title="__('Telegram Bots')">
    <div class="container mx-auto px-4 py-6 space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('admin.telegram-bots.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200">
	                        ...
	                        <td class="px-6 py-4">
	                            <div class="flex justify-center gap-2">
	                                ...
	                                @if($bot->services->count() === 0)
	                                    <form action="{{ route('admin.telegram-bots.destroy', $bot) }}" method="POST" class="inline delete-bot-form">
	                                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.delete-bot-form').forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        ...
                        text: "Data bot ini akan dihapus permanen!",
                        icon: 'warning',
